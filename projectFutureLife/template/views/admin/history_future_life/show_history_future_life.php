...
<?php
    ...
    } else if (isset($_GET['from_time']) && $_GET['from_time'] != "") {
    ...
    if (isset($_POST['from_time'])) {
        $value_from_time = $_POST['from_time'];
    ...
    if (isset($_POST['to_time'])) {
        $value_to_time = $_POST['to_time'];
    } else if (isset($_GET['to_time'])) {
        ...
        <ul class="list-page">
            ...
            ?>
                <li <?php if ($i == $page_get) {
                    ...
                    // Request from time
                    if (isset($_POST['from_time']) && $_POST['from_time'] != "") {
                        $request_from_time = "&from_time=".$_POST['from_time'];
                    } else if (isset($_GET['from_time']) && $_GET['from_time'] != "") {
                    ...
                    // Request to time
                    if (isset($_POST['to_time']) && $_POST['to_time'] != "") {
                        $request_to_time = "&to_time=".$_POST['to_time'];
                    } else if (isset($_GET['to_time']) && $_GET['to_time'] != "") {
