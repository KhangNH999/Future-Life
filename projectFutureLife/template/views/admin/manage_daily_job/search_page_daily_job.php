...
<?php
  ...
  (isset($_GET['name']) && $_GET['name'] != "") ? $daily_job_name = $_GET['name'] : $daily_job_name;
  (isset($_GET['time_from']) && $_GET['time_from'] != "") ? $time_start_from = $_GET['time_from'] : $time_start_from;
  (isset($_GET['time_from']) && $_GET['time_from'] != "") ? $time_start_from = $_GET['time_from'] : $time_start_to;
  (isset($_GET['time_to']) && $_GET['time_to'] != "") ? $time_start_to = $_GET['time_to'] : $time_start_to;
          ...
          <li 
            <?php 
              ...
              <?php 
                ...
                // Request time from
                if (isset($_GET['time_from']) && $_GET['time_from'] != "") {
                ...
                // Request time to
                if (isset($_GET['time_to']) && $_GET['time_to'] != "") {
